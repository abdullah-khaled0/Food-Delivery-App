...
class AppColors{
  ...
  static final Color mainColor = const Color(0xffeecb7d);
  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xffd3802a);
  static final Color iconColor2 = const Color(0xffe7ef08);
  ...
  static final Color yellowColor = const Color(0xffce9d37);
